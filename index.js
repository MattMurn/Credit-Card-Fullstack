...
let day_65 = new Date("December 27, 2018 15:13:20") //65 days
    ...
    console.log(test_plus.get_balance_as_of_date(second_transaction_date));//500
    test_plus.card_transaction('payment', 200, second_transaction_date);
    console.log(test_plus.get_balance_as_of_date(third_transaction_date))//300
    test_plus.card_transaction('charge', 100, third_transaction_date);
    console.log(test_plus.get_balance_as_of_date(check_balance_date))//411.99
    console.log(test_plus.get_balance_as_of_date(day_35))
    test_plus.card_transaction('charge', 300, day_40);
    console.log(test_plus.get_balance_as_of_date(day_45))//411.99
    console.log(test_plus.get_balance_as_of_date(day_60))// calc interest

    console.log(test_plus.calc_interest(711.99, 15));
    console.log(test_plus.calc_interest(411.99, 30))
    ...
    console.log(checkDay(33), checkDay(8));

    // console.log(test_two.get_balance_as_of_date(day_65)) // calc interest